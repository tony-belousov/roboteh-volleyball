(function () {
  ...
  const robotechPlayers = [
    makePlayer({ id: 'robotech-1', teamId: 'robotech', number: 1, fullName: 'Байнякшин Роман Сергеевич', birthDate: '1985-03-29', role: 'Связующий', roleKey: 'setter', height: 188, status: 'основной состав' }),
    makePlayer({ id: 'robotech-2', teamId: 'robotech', number: 2, fullName: 'Биркин Александр Сергеевич', birthDate: '1993-06-18', role: 'Блокирующий', roleKey: 'middle', height: 202, status: 'основной состав' }),
    makePlayer({ id: 'robotech-3', teamId: 'robotech', number: 3, fullName: 'Жученко Иван Петрович', birthDate: '1983-10-28', role: 'Блокирующий', roleKey: 'middle', height: 201, status: 'основной состав' }),
    makePlayer({ id: 'robotech-4', teamId: 'robotech', number: 4, fullName: 'Кудряшов Егор Николаевич', birthDate: '1995-01-10', role: 'Диагональный', roleKey: 'opposite', height: 198, status: 'основной состав' }),
    makePlayer({ id: 'robotech-5', teamId: 'robotech', number: 5, fullName: 'Лебедев Владимир Олегович', birthDate: '1989-12-05', role: 'Доигровщик', roleKey: 'outside', height: 193, status: 'основной состав' }),
    makePlayer({ id: 'robotech-6', teamId: 'robotech', number: 6, fullName: 'Несоленов Андрей Юрьевич', birthDate: '1995-09-18', role: 'Связующий', roleKey: 'setter', height: 187, status: 'основной состав' }),
    makePlayer({ id: 'robotech-7', teamId: 'robotech', number: 7, fullName: 'Охрименко Сергей Александрович', birthDate: '1991-03-31', role: 'Диагональный', roleKey: 'opposite', height: 199, status: 'основной состав' }),
    makePlayer({ id: 'robotech-8', teamId: 'robotech', number: 8, fullName: 'Сивенцев Артем Александрович', birthDate: '1989-10-23', role: 'Блокирующий', roleKey: 'middle', height: 203, status: 'запас' }),
    makePlayer({ id: 'robotech-9', teamId: 'robotech', number: 9, fullName: 'Сурков Олег Сергеевич', birthDate: '1998-07-19', role: 'Доигровщик', roleKey: 'outside', height: 194, status: 'запас' }),
    makePlayer({
      id: 'robotech-10',
      teamId: 'robotech',
      number: 10,
  ...
  const robotech2Players = [
    makePlayer({ id: 'robotech2-1', teamId: 'robotech_2', number: 1, fullName: 'Белоусов Антон Николаевич', birthDate: '1999-11-27', role: 'Доигровщик', roleKey: 'outside', height: 193, status: 'основной состав' }),
    makePlayer({ id: 'robotech2-2', teamId: 'robotech_2', number: 2, fullName: 'Головин Максим Геннадьевич', birthDate: '1988-06-23', role: 'Блокирующий', roleKey: 'middle', height: 202, status: 'основной состав' }),
    ...
    makePlayer({ id: 'robotech2-11', teamId: 'robotech_2', number: 11, fullName: 'Яковлев Александр Иванович', birthDate: '1993-07-05', role: 'Доигровщик', roleKey: 'outside', height: 194, status: 'запас' })
  ];
